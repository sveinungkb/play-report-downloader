...
public class SalesReportContextIntegrationTest {
	...
	public void retrieveEstimatedSalesReportSequence() {
		...
		PlayLogin playLogin = salesReportContext.createStep();
		...
		SecurityCheck securityCheck = salesReportContext.createStep();
		...
		DeveloperAccount developerAccount = salesReportContext.createStep();
		...
		String salesReportContent = salesReportContext.createStep();
